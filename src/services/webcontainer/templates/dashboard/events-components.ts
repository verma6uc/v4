export const eventsComponents = {
  'src/components/events/StockEvents.tsx': {
    file: {
      contents: `
import React, { useState } from 'react';
import { Search, Filter, Package, Shield, Truck, ChevronLeft, ChevronRight } from 'lucide-react';
...
export function StockEvents({ events }: StockEventsProps) {
