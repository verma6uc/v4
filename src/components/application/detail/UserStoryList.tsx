...
import { ChevronDown, ChevronRight, Clock, Tag, ListChecks, MoreVertical } from 'lucide-react';
...
export function UserStoryList({ stories }: UserStoryListProps) {
  ...
  return (
    <div>
      {stories.map(story => (
        <div key={story.id} className="border-b border-gray-200 last:border-b-0 group">
          {/* Story Header */}
          <div 
