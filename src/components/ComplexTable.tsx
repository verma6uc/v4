...
import { ChevronDown, ChevronLeft, ChevronRight, ChevronUp, Download, Eye, Filter, MoreHorizontal, Trash } from 'lucide-react'
...
export function ComplexTable({ title, description }: ComplexTableProps) {
  ...
  return (
    <div className="bg-white/70 backdrop-blur-xl rounded-xl shadow-sm border border-white/20 p-6">
      ...
      {/* Filters Section */}
      {showFilters && (
        <div className="mt-4 bg-gray-50/50 rounded-lg border border-gray-200 p-4">
          <TableFilters
